...
function $$(selector) {
    ...
    return [].concat(_toConsumableArray(scope.querySelectorAll(selector)));
}
...
var Turbolinks = __webpack_require__(17);
...
_highlight2.default.registerLanguage('xml', __webpack_require__(5));
_highlight2.default.registerLanguage('bash', __webpack_require__(6));
_highlight2.default.registerLanguage('css', __webpack_require__(7));
_highlight2.default.registerLanguage('markdown', __webpack_require__(8));
_highlight2.default.registerLanguage('javascript', __webpack_require__(9));
_highlight2.default.registerLanguage('json', __webpack_require__(10));
_highlight2.default.registerLanguage('nginx', __webpack_require__(11));
_highlight2.default.registerLanguage('php', __webpack_require__(12));
_highlight2.default.registerLanguage('go', __webpack_require__(13));
_highlight2.default.registerLanguage('sql', __webpack_require__(14));
_highlight2.default.registerLanguage('scss', __webpack_require__(15));

function init() {
    (0, _dom.$$)('pre code').forEach(_highlight2.default.highlightBlock);
};
...
function registerSidebarEvents() {
    (0, _dom.$$)('.js-sidebar-show').forEach(function (el) {
        return (0, _dom.on)('click', el, showSidebar);
    });
    (0, _dom.$$)('.js-sidebar-hide').forEach(function (el) {
        return (0, _dom.on)('click', el, hideSidebar);
    });
    (0, _dom.$$)('.js-sidebar-toggle').forEach(function (el) {
        return (0, _dom.on)('click', el, toggleSidebar);
    });
}
...
function registerSidebarTogglerEvents() {
    var updateSidebarTogglerState = function updateSidebarTogglerState(state) {
        var newState = applySidebarTogglerState(state);

        requestAnimationFrame(function () {
            return updateSidebarTogglerState(newState);
        });
    };
